...
/*
			...
			client.getStatusComment({
				status_id : 1934589872,//状态的id
				owner_id : 282078819//状态所有者的id
...
*/
            ...
            /*
			client.getPhotoInfo({
				uid : 282078819,//照片所有者的用户ID或公共主页的ID
				aid : '445937481',//相册的id。aid和pids至少传递一个
				//password : '123456',//加密相册的密码。如果相册为加密相册，传递此参数。
				//page : 1,//页码，默认值为1，必须大于0，无上限
				//count : 10,//每页的容量，默认值为10，必须大于0，无上限
				pids : '3170918907,3170918905'//照片id串，以分","割，最多20个。aid和pids至少传递一个，传递pids则无需传递page和count参数
			},function(ret){
...
/*
			client.addPhotoComment({
                ...
                uid : '282078819',//评论人的id
				//aid : 123,//相册的id。aid和pid至少传递一个
				pid : '3170918907'//照片id。aid和pid至少传递一个
...
*/
			...
			client.getPhotoComments({
				uid : 282078819,//照片或相册所有者的用户ID
				aid	: 382582170//相册的id。aid和pid至少传递一个
...
/*
			client.getBlogInfo({
				id : 723988746,//日志id
				uid : 282078819//日志所有者的ID或公共主页的ID
